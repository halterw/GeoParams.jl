function Txx_rot,Tyy_rot,Txy_rot, η_ve, anifacve = ViscoElasticTrialStress_Newton(Exx_rot, Eyy_rot, Exy_rot, Txx_o_rot, Tyy_o_rot, Txy_o_rot, ηv, ηe, anifacv, aniface, tol, nitmax, noisy)
#function LocalViscoElasticTrialStress_Newton_ηve_ani_fac( ε_rot, τ0_rot, ηe, aniface, anifacv, B, C, npwl, tol, nitmax, noisy )
    ...
    D       = 2*ηve * [1 0 0; 0 1 0; 0 0 1.0/anifacve]
    τ_vec   = D*[Exx_ve; Eyy_ve; Exy_ve]
    τ_rot   = [τ_vec[1] τ_vec[3]; τ_vec[3] τ_vec[2]]

    return τ_rot, ηve, anifacve, ηpwl
